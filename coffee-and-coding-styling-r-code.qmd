...
-   Effective for maintaining styling for new projects but hard to apply
    to old ones

-   Highly customisable, e.g. if you want to relax/not apply some rules

-   RStudio brings up a handy window where you can click through to
    address individual lints
